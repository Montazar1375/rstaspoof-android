نسخه اندروید پروژه رو یکی از دوستان زحمت کشیده.

داخل نسخه اندروید یه ای پی تمیز کلود فلر نیاز دارین. بذارین جای ای پی بعد اپ رو استارت میکنین.
بعدش میرین داخل v2rayng یا برنامه دیگه برنامه rsta spoof رو داخل برنامه هایی که تونل نمیشن میذارین.
ویدیو آموزشم فایل mp4 همین جا هست.
