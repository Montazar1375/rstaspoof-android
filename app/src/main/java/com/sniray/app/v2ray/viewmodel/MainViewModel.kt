package com.sniray.app.v2ray.viewmodel
...
import com.sniray.app.v2ray.dto.GroupMapItem
import com.sniray.app.v2ray.dto.SubscriptionUpdateResult
import com.sniray.app.v2ray.dto.TestServiceMessage
import com.sniray.app.v2ray.dto.entities.ServersCache
import com.sniray.app.v2ray.dto.entities.SubscriptionCache
import com.sniray.app.v2ray.extension.isComplexType
import com.sniray.app.v2ray.extension.matchesPattern
...
import com.sniray.app.v2ray.handler.SpeedtestManager
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /**
     * Tests the real ping for all servers through the SNI bypass chain.
     */
    fun testAllRealPingWithSni() {
        if (RstaBypassConfigInjector.getActiveBypassConfigId() < 0L) {
            getApplication<AngApplication>().toastError(R.string.toast_real_ping_sni_no_profile)
            return
        }
