...
import com.sniray.app.v2ray.enums.NotificationChannelType
import com.sniray.app.v2ray.extension.serializable
...
import com.sniray.app.v2ray.util.NotificationHelper
...
class CoreTestService : Service() {
    ...
    private fun handleMeasureStart(message: TestServiceMessage, startId: Int) {
        ...
        val notificationTitle = if (message.useSniChain) {
            getString(R.string.title_real_ping_all_server_sni)
        } else {
        ...
        if (guidsList.isNotEmpty()) {
            ...
            worker = RealPingWorkerService(
                context = this,
                guids = guidsList,
                useSniChain = message.useSniChain,
