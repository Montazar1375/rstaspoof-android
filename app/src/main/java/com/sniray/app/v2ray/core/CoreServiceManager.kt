package com.sniray.app.v2ray.core
...
import com.sniray.app.v2ray.contracts.ServiceControl
import com.sniray.app.v2ray.dto.OutboundTrafficStat
...
import com.sniray.app.v2ray.service.CoreProxyOnlyService
import com.sniray.app.v2ray.service.CoreVpnService
import com.sniray.app.v2ray.service.DialerNativeService
...
object CoreServiceManager {
    ...
    fun startVService(context: Context, guid: String? = null) {
        ...
        AngApplication.appScope.launch {
            if (RstaVpnBootstrap.shouldBootstrapVpn()) {
                val bootstrap = withContext(Dispatchers.IO) {
                    RstaVpnBootstrap.ensureBypassRunning(appContext)
                }
                if (bootstrap.isFailure) {
                    val message = bootstrap.exceptionOrNull()?.message ?: "SNI bypass failed"
                    bootstrap.exceptionOrNull()?.let { LogUtil.e(AppConfig.TAG, "StartCore-Manager: $message", it) }
