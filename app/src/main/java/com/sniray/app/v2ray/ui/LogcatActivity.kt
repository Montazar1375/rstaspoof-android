...
import com.sniray.app.databinding.ActivityLogcatBinding
...
import com.sniray.app.v2ray.viewmodel.LogcatViewModel
    ...
    private fun shareLogcat() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val result = try {
                ...
                val logFile = File(shareDir, "sniray_logcat_$timestamp.txt")
